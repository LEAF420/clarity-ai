              ...
              <TabsContent value="ollama" className="space-y-4">
                <Card className="bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="text-xs text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-md p-3">
                      <p><strong>Note:</strong> Ollama Mode is only available when running Clarity on your own computer (localhost). Hosted web apps cannot access local Ollama for security reasons (CORS).</p>
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
