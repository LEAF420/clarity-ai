          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              <a 
                ...
                className="inline-flex items-center space-x-2 text-3xl font-bold text-foreground tracking-tight hover:text-primary transition-colors cursor-pointer"
              >
                <span>Gemma 3n Impact Challenge Edition</span>
